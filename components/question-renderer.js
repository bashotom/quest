    ...
    static renderResultTable(scores, questions, config, container) {
        ...
        tbody.addEventListener('click', (event) => {
            ...
            if (existingDetailsRow) {
                ...
                const detailsRow = QuestionRenderer.createCategoryQuestionsRow(categoryKey, questions, config);
                row.insertAdjacentElement('afterend', detailsRow);
            }
        });
    }

    static createCategoryQuestionsRow(categoryKey, questions, config) {
        const categoryQuestions = questions.filter(q => q.category === categoryKey);
        const currentAnswers = QuestionRenderer.collectCurrentAnswers(questions);
